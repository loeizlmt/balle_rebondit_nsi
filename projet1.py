...
def draw():# cette fonction s'exécute  en boucle 60 fois par seconde...
    ...
    if bx < r or bx > 500 - r:
        ...
        if r == 10 : 
            toto = toto + 1
        bx = bx # replace la balle pour éviter que la balle rebondisse à l'infini sur le côté
    ...
    if by < r or by > 400 - r: 
        ...
        if r == 10 : 
            toto = toto + 1
        by = by # replace la balle pour éviter que la balle rebondisse à l'infini sur le côté
